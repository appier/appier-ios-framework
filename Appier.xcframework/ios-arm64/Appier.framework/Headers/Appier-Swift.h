...
- (void)enableInAppCampaigns;
- (void)disableInAppCampaigns;
...
- (void)getRecommendationWithScenarioId:(NSString * _Nonnull)scenarioId productId:(NSString * _Nonnull)productId queryParameters:(NSDictionary<NSString *, id> * _Nullable)queryParameters completionHandler:(void (^ _Nonnull)(id _Nullable))completionHandler;
- (void)getRecommendationTagsWithRequest:(AIQRecommendationRequest * _Nonnull)request completionHandler:(void (^ _Nonnull)(AIQRecommendationTagResponse * _Nullable))completionHandler;
- (void)getRecommendationProductsWithRequest:(AIQRecommendationRequest * _Nonnull)request completionHandler:(void (^ _Nonnull)(AIQRecommendationProductResponse * _Nullable))completionHandler;
...
- (NSArray * _Nonnull)fetchStoredPushNotifications SWIFT_WARN_UNUSED_RESULT;
- (void)deleteStoredPushNotifications;
- (void)deleteNotificationAt:(NSUInteger)index;
- (void)enablePushNotificationStorage;
- (void)setPushNotificationStorageLimit:(NSInteger)limit;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) Rmn * _Nullable Rmn;)
+ (Rmn * _Nullable)Rmn SWIFT_WARN_UNUSED_RESULT;
+ (void)renewAppierId:(AsyncResult<id> * _Nullable)asyncResult;
...
+ (void)logEvent:(NSString * _Nonnull)name withParameters:(NSDictionary * _Nullable)param;
+ (void)logEvent:(NSString * _Nonnull)name withValueToSum:(NSNumber * _Nullable)valueToSum;
+ (void)logEvent:(NSString * _Nonnull)name withValueToSum:(NSNumber * _Nullable)valueToSum currency:(NSString * _Nullable)currency;
+ (void)logEvent:(NSString * _Nonnull)name withParameters:(NSDictionary * _Nullable)param valueToSum:(NSNumber * _Nullable)valueToSum;
+ (void)logEvent:(NSString * _Nonnull)name withParameters:(NSDictionary * _Nullable)param valueToSum:(NSNumber * _Nullable)valueToSum currency:(NSString * _Nullable)currency;
+ (void)setAttributionWindow:(NSInteger)seconds;
+ (void)setClickAttributionWindow:(NSInteger)seconds;
...
SWIFT_PROTOCOL_NAMED("InAppRecommendationDataProviderProtocol")
@protocol AIQInAppRecommendationDataProviderProtocol
...
/// @param maxAmount The maximum number of product advertisements to retrieve.
...
- (void)searchProductAdsWithKeyword:(NSString * _Nonnull)keyword placementId:(NSInteger)placementId maxAmount:(NSInteger)maxAmount products:(NSArray<RmnProduct *> * _Nonnull)products asyncResult:(AsyncResult<RmnPostAdsResponse *> * _Nonnull)asyncResult;
...
SWIFT_CLASS("_TtC6Appier18RmnPostAdsResponse")
@interface RmnPostAdsResponse : AIQObject
@property (nonatomic, copy) NSArray<RmnProductAdsPlacement *> * _Nonnull productsPlacements;
...
@property (nonatomic, copy) NSString * _Nullable category;
@property (nonatomic, copy) NSArray<NSString *> * _Nullable subCategories;
...
+ (RmnSale * _Nonnull)fromProductAdWithProductAd:(RmnProductAd * _Nonnull)productAd category:(NSString * _Nonnull)category quantity:(NSInteger)quantity unitPrice:(float)unitPrice currency:(NSString * _Nonnull)currency SWIFT_WARN_UNUSED_RESULT;
