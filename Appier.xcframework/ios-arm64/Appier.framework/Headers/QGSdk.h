...
/*!
 ...
 Add this method to your AppDelegate application:didFinishLaunchingWithOptions:
...
/*!
 ...
 @deprecated Use onStart: or onStart:withAppGroup: instead. The devProfile parameter is ignored.

 @param appId           your QGraph account appId
 @param devProfile      deprecated, has no effect
 */
- (void)onStart:(NSString *)appId setDevProfile:(BOOL)devProfile
    DEPRECATED_MSG_ATTRIBUTE("Use onStart: instead. The devProfile parameter has no effect.");

/*!
 @abstract
 Set the app id, app group and profile to setup sdk

 @deprecated Use onStart:withAppGroup: instead. The devProfile parameter is ignored.
...
- (void)onStart:(NSString *)appId withAppGroup:(nullable NSString *)appGroup setDevProfile:(BOOL)devProfile
    DEPRECATED_MSG_ATTRIBUTE("Use onStart:withAppGroup: instead. The devProfile parameter has no effect.");
