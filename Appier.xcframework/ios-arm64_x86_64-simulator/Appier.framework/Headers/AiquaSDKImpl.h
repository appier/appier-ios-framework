...
/*!
 ...
 In UIScene-based apps, call this during scene setup (e.g. scene:willConnectToSession:options:)
 to align initialization with the active scene lifecycle.
 
 IMPORTANT: Call this method exactly once per launch. If your app uses UIScene,
 call from SceneDelegate and do NOT also call from AppDelegate to avoid redundant execution.
 AppDelegate-based apps remain supported for iOS 12 and earlier.
 */
...
/*!
 ...
 For UIScene-based apps, remote notification callbacks are still delivered via AppDelegate.
