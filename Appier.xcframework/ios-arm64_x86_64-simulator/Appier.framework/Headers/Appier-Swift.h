...
+ (NSData * _Nullable)encryptWithArray:(NSArray * _Nonnull)array keyBase:(NSString * _Nonnull)keyBase error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
+ (NSArray * _Nullable)decryptToArrayWithData:(NSData * _Nonnull)data keyBase:(NSString * _Nonnull)keyBase error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
