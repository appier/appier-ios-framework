...
@property (nonatomic, readonly, strong) AIQUALocalStorage * _Nonnull storage;
...
SWIFT_CLASS("_TtC6Appier17AIQUALocalStorage")
@interface AIQUALocalStorage : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) AIQUALocalStorage * _Nonnull shared;)
+ (AIQUALocalStorage * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
+ (void)setShared:(AIQUALocalStorage * _Nonnull)value;
- (nonnull instancetype)init;
...
/// When the app is installed for the first time, we are unable to retrieve the QG_APP_GROUP_NAME_SDK prior to initialization. As a result, the UserDefaults of AIQUALocalStorage.shared does not refer to the QG_APP_GROUP_NAME_SDK that the SDK is supposed to utilize.
...
@interface AIQUALocalStorage (SWIFT_EXTENSION(Appier))
/// QGUtility compatible
- (void)saveWithValue:(id _Nullable)value key:(NSString * _Nonnull)key;
/// QGUtility compatible
- (id _Nullable)getValueFor:(NSString * _Nonnull)key SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_PROTOCOL("_TtP6Appier12AIQUAStorage_")
@protocol AIQUAStorage
- (void)clean;
@property (nonatomic) BOOL devProfile;
...
/// This is equivalent to <em>appVersion != nil</em>
...
/// This is equivalent to <em>lastViewThroughTime != nil</em>
@property (nonatomic, readonly) BOOL hasLastViewThroughTime;
@property (nonatomic, copy) NSDate * _Nullable lastClickedNotificationTime;
/// This is equivalent to <em>lastClickedNotificationTime != nil</em>
@property (nonatomic, readonly) BOOL hasLastClickedNotificationTime;
...
/// This is equivalent to <em>clickAttributionWindow != nil</em>
@property (nonatomic, readonly) BOOL hasClickAttributionWindow;
/// [“point”: [longitude, latitude]]
@property (nonatomic, copy) NSDictionary<NSString *, NSArray<NSNumber *> *> * _Nullable lastLocation;
/// This is equivalent to <em>lastLocation != nil</em>
...
@property (nonatomic) BOOL sendIdfaWithConsent;
...
/// Use this status only if hasPersonalizationDisabledStatus is true. Otherwise, it is false.
...
@property (nonatomic) BOOL forceTouchCapabilityStatus;
...
@interface AIQUALocalStorage (SWIFT_EXTENSION(Appier)) <AIQUAStorage>
- (void)clean;
@property (nonatomic) BOOL devProfile;
@property (nonatomic, copy) NSString * _Nullable appID;
@property (nonatomic, readonly) BOOL hasAppID;
