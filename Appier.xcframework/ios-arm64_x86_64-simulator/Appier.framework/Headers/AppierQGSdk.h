...
- (void)onStop DEPRECATED_MSG_ATTRIBUTE();
...
/*!
 ...
 @discussion
 Call this method exactly once during app initialization:
 
 For UIScene-based apps (iOS 13+):
 - Call from SceneDelegate scene:willConnectToSession:options:
 - Do NOT also call from AppDelegate
 
 For AppDelegate-based apps (iOS 12 and earlier):
 - Call from AppDelegate application:didFinishLaunchingWithOptions:
 
 The SDK automatically handles both lifecycle models.
 */
...
- (void)logRecommendationClickedWithScenarioId:(NSString *)scenarioId
                                 ...
                                 withProductId:(NSString *)productId
                          withRecommendationId:(NSString *)recommendationId DEPRECATED_MSG_ATTRIBUTE("Use modelId in String value and call logRecommendationClickedWithScenarioId:withModelIdString:withProductId:withRecommendationId: instead.");
...
/*!
 ...
 @code
 [[QGSdk getSharedInstance] logRecommendationClickedWithScenarioId:@"sid" withModelIdString:@"19023" withProductId:@"XXX-SKU" withRecommendationId:@"recId"];
 @endcode

 Parse the response object and use it as required
 */
- (void)logRecommendationClickedWithScenarioId:(NSString *)scenarioId
                             withModelIdString:(NSString *)modelIdString
                                 withProductId:(NSString *)productId
