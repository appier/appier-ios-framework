...
SWIFT_CLASS("_TtC6Appier10AIDManager") SWIFT_DEPRECATED
@interface AIDManager : NSObject
- (void)initWithApiKey:(NSString * _Nonnull)key SWIFT_METHOD_FAMILY(none) SWIFT_DEPRECATED_MSG("", "configure(apiKey:)");
- (void)initPage:(UIViewController * _Nonnull)vctl PageType:(NSString * _Nonnull)PageType Scrollable:(UIScrollView * _Nullable)Scrollable IsLogin:(BOOL)IsLogin ItemPrice:(NSNumber * _Nullable)ItemPrice CartPrice:(NSNumber * _Nullable)CartPrice SWIFT_METHOD_FAMILY(none) SWIFT_DEPRECATED_MSG("", "startLogging");
- (void)initPage:(UIViewController * _Nonnull)vctl pageType:(NSString * _Nonnull)pageType scrollable:(UIScrollView * _Nullable)scrollable isLogin:(BOOL)isLogin itemPrice:(NSNumber * _Nullable)itemPrice cartPrice:(NSNumber * _Nullable)cartPrice SWIFT_METHOD_FAMILY(none) SWIFT_DEPRECATED_MSG("", "startLogging");
- (void)deinitPage SWIFT_DEPRECATED;
- (void)sendConversionInfo:(AIDConversion * _Nonnull)conversionInfo SWIFT_DEPRECATED;
+ (AIDManager * _Nonnull)instance SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_MSG("", "shared");
